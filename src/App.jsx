...
const App = () => {
  const [generatedJSON, setGeneratedJSON] = useState(generateRandomJSON);
  ...
  return (
    <div style={{margin:"10vw"}} className="App">
      <h1>JSON Generator </h1>
      <div style={{marginInline:"5vw"}}>
        <button onClick={handleGenerateClick}>Generate JSON</button>
      </div>
      <div>
        <h2>Generated JSON:</h2>
        <Card jsonData={generatedJSON} />
      </div>
    </div>
  );
};
